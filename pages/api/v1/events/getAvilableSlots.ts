...
import { isSlotWithinWorkingTime, isWorkingDay } from '@/pages/lib/utils/isSlotWithinWorkingHours';
...
export const isConflictWithBookingTime = ({
  ...
  for (const { endTime: bookinEndTime, startTime: bookingStartTime } of booking) {
    if (
      timeOverLap({
